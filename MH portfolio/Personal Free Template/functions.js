// @codekit-prepend "TweenLite.min.js";
// @codekit-prepend "TimelineLite.min.js";
// @codekit-prepend "CSSPlugin.min.js";
// @codekit-prepend "CSSRulePlugin.min.js";
// @codekit-prepend "ScrollToPlugin.min.js";
// @codekit-prepend "jquery.gsap.min.js";
// @codekit-prepend "ScrollMagic.min.js";
// @codekit-prepend "animation.gsap.min.js";
// @codekit-prepend "jquery.ScrollMagic.min.js";
...
$(document).ready(function() {
  ...
  $('a[href*="#"]:not([href="#0"])').click(function(ev) {
	...
	if ($(window).width() > 991) {  
	  ...
	  aboutTl
	  	.from($aboutBlurb, 0.8, {x: 50, opacity: 1, ease: Power1.easeOut})
	  	.from($aboutVisual, 0.8, {x: -50, opacity: 1, ease: Power1.easeOut}, 0)
	  	.from($aboutFrame, 0.8, {cssRule:{opacity: 1}, ease: Power1.easeOut})
	  	.from($aboutSignature, 0.8, {opacity: 1}, '-=0.4');
	  ...
	  var webDesignScene = new ScrollMagic.Scene({
	  	...
	  	.setTween(TweenLite.from($webDesignVisual, 0.8, {x: -100, opacity: 1, ease: Power1.easeOut}))
	  	.addTo(controller);
	  ...
	  workTl
	  	...
	  	.from($workContent, 0.8, {x: -50, opacity: 1, ease: Power1.easeOut})
	  	.from($workVisual, 0.8, {x: 50, opacity: 1, ease: Power1.easeOut}, 0)
	  	.from($workFrame, 0.8, {cssRule:{opacity: 1}, ease: Power1.easeOut});
	  ...
	  blogTl
	  	.staggerFrom($blogPost, 0.8, {opacity: 1, ease: Power1.easeOut}, 0.4)
	  	.from($blogButton, 0.8, {opacity: 1, ease: Power1.easeOut}, '-=0.2');
	  ...
	  contactTl
	  	.from($contactForm, 0.8, {x: 50, opacity: 1, ease: Power1.easeOut})
	  	.from($contactVisual, 0.8, {x: -50, opacity: 1, ease: Power1.easeOut}, 0)
	  	.from($contactFrame, 0.8, {cssRule:{opacity: 1}, ease: Power1.easeOut});
